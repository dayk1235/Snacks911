...
- **Cross-platform.** Use Glob, Read, and Grep tools -- not Bash `ls`, `find`, or `cat`. Bash file commands fail on Windows. Only use Bash for `node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel` CLI calls.
...
```bash
node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/stack.json --cwd <project_root>
```
...
```bash
node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/files.json --cwd <project_root>
```
...
```bash
node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/apis.json --cwd <project_root>
```
...
```bash
node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/deps.json --cwd <project_root>
```
...
Run: `node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel validate --cwd <project_root>`
...
Run: `node /Users/theboy/Downloads/snacks911-web/.codex/get-shit-done/bin/gsd-tools.cjs intel snapshot --cwd <project_root>`
