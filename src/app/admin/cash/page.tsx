...
export default function CashPage() {
  const { 
    session, movements, salesByMethod, isLoading, 
    fetchSession, addMovement 
  } = useCashStore();
  ...
  return (
    <div style={{ 
      ...
      {/* 📝 REGISTRATION FORM */}
      <div style={{ background: '#111', borderRadius: '20px', padding: '1.5rem', marginBottom: '2rem', border: '1px solid #222' }}>
        <input 
        ...
        <button 
          ...
          style={{ 
            ...
            opacity: isLoading ? 0.5 : 1, cursor: 'pointer'
          }}
        >
