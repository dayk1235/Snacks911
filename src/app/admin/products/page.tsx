  ...
  const filtered = products.filter((p) => {
    ...
    const normalizeText = (text: string) =>
      text
        ...
        .normalize("NFD")
        .replace(/[\u0300-\u036f]/g, "");
    const matchQ = normalizeText(p.name).includes(normalizeText(search));
        ...
        {filtered.map((p) => (
          <div key={p.id} style={{ ...CARD, overflow: "hidden" }}>
            ...
            <div
              style={{
                height: "100px",
                background: `url(${getProductImage(p)}) center/cover`,
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  style={{
                    ...inputStyle,
                    border: formErrors.name ? errorBorder : inputStyle.border,
                  }}
                  placeholder="Ej: Alitas BBQ"
                />
                {formErrors.name && (
                  <span style={errorText}>Campo obligatorio</span>
                )}
              </label>
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFormErrors((e2) => ({ ...e2, price: false }));
                    }}
                    style={{
                      ...inputStyle,
                  ...
                  />
                  {formErrors.price && (
                    <span style={errorText}>Precio inválido</span>
                  )}
                </label>
              ...
              >
                ...
                <textarea
                  ...
                  onChange={(e) => {
                    ...
                    setFormErrors((e2) => ({ ...e2, description: false }));
                  }}
                  rows={2}
                  style={{
                    ...inputStyle,
                ...
                {form.imageUrl ? (
                  ...
                  >
                    ...
                    <span style={{ fontSize: "0.72rem", color: "#555" }}>
                      Click para seleccionar · JPG, PNG — máx. 2MB
                    </span>
                  </button>
                )}
